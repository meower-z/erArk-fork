...
def judge_character_follow(character_id: int) -> int:
    ...
    if character_data.sp_flag.is_follow == 1:
        # 取消所有工作和娱乐状态
        default.handle_cancel_all_work_and_entertainment_flag(character_id, cache.character_data[character_id].target_character_id, 1, game_type.CharacterStatusChange(), datetime.datetime(1, 1, 1))
        return 1
