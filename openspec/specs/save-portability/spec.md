# save-portability Specification

## Purpose
Define safe loading of structured game room addresses across supported operating-system separators without rewriting ordinary save text.
