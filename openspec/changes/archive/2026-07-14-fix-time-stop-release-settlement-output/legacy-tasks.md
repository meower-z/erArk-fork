...
- [x] 0.2 Candidate code is present on local `main`; both focused files pass together (58 tests, 2026-07-14), but this is not accepted as end-to-end proof
...
- [ ] 3.3 Focused unit/component tests pass (58 tests); still run real enabled-mod integration, Tk settlement rendering, independent Web collection, and relevant time-stop/H regressions, then inspect the actual narrow diff
...
- [ ] 3.7 Verify the corrected global K/M/sign formatter at core state, core experience, batch-mod output, and other non-time-stop call sites
